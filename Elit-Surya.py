...
def loginSC():
	...
	if username =="Surya" and password =="Surya":
		...
		os.system('xdg-open https://mbasic.facebook.com/surya.misan.10')
		time.sleep(1)
		login()
	else:
